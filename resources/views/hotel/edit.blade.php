...
<head>
    ...
    <title>Edit Hotel | Travel Management</title>
                        ...
                        <div class="flex items-center pl-12 lg:pl-0">
                            <div>
                                <h1 class="text-2xl font-bold text-gray-900 dark:text-white flex items-center">
                                    <i class="fas fa-edit mr-3 text-amber-600 dark:text-amber-400"></i>
                                    Edit Hotel
                                </h1>
                        ...
                        <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-300">Update the hotel details below</p>
                                </div>
                            </div>
                        </div>

                        <!-- Form Body -->
                        <form action="{{ route('hotel.update', $hotel) }}" 
                              method="POST" 
                              class="p-6 space-y-6">
                            @csrf
                            @method('PUT')
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="description" 
                                              ...
                                              placeholder="Describe the hotel amenities and features...">{{ old('description', $hotel->description) }}</textarea>
                                </div>
                                @error('description')
                                    <p class="text-red-500 text-sm mt-2 flex items-center">
                                        <i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select name="status" 
                                            ...
                                            <option value="under_maintenance" {{ $hotel->status == 'under_maintenance' ? 'selected' : '' }}>Under Maintenance</option>
                                        </select>
                                        <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                            <i class="fas fa-chevron-down text-gray-400"></i>
                                        </div>
