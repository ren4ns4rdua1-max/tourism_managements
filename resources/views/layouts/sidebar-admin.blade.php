...
<aside class="hidden lg:flex lg:flex-shrink-0 fixed top-0 left-0 h-screen z-40">
    <div class="flex flex-col w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 h-full">
        <!-- Logo/Brand Section -->
        <div class="h-16 flex items-center justify-center border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-violet-50 to-purple-50 dark:from-gray-800 dark:to-gray-800 flex-shrink-0">
...
@if(request()->routeIs('tour-package.*'))
                <a href="{{ route('tour-package.index') }}"
                   class="flex items-center px-4 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-semibold shadow-md hover:shadow-lg rounded-lg transition-all duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
